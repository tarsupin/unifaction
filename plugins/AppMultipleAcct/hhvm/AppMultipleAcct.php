...
/****** Check if a user has access to a specific account ******/
	...
	(
		int $uniID			// <int> The UniID to check if they have access.
	,	int $accessID		// <int> The UniID that is being tested for access.
	): bool					// RETURNS <bool> TRUE if the user has access, FALSE if not.
...
/****** Retrieve a list of accounts that a user has access to ******/
	...
	(
		int $uniID			// <int> The UniID to find multiple access accounts of.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> a list of accounts that the user has access to.
...
/****** Retrieve a list of accounts that a user has granted to other accounts ******/
	...
	(
		int $uniID			// <int> The UniID to find multiple access accounts of.
	): array <int, array<str, mixed>>					// RETURNS <int:[str:mixed]> a list of accounts that the user has granted access to.
...
/****** Grant access to an account ******/
	...
	(
		int $uniID			// <int> The UniID that is receiving access to another account.
	,	int $uniIDGranted	// <int> The UniID being granted to the target account.
...
/****** Remove access from an account ******/
	...
	(
		int $uniID			// <int> The UniID that is losing access to another account.
	,	int $uniIDRemoved	// <int> The UniID being stripped from the target account.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
