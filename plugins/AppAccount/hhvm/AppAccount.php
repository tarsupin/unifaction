...
/****** Retrieve a list of handle suggestions (during profile creation) ******/
	...
	(
		string $handle			// <str> The handle that was attempted.
	): array <int, str>					// RETURNS <int:str> list of handles that could be chosen.
...
/****** Check if a handle is already taken ******/
	...
	(
		string $handle			// <str> The handle that you want to check for availability.
	): bool					// RETURNS <bool> TRUE if taken, FALSE if not.
...
/****** Check if the user is set to receive a new invite today (run during login) ******/
	...
	(
		int $uniID			// <int> The UniID of the person to test for an invite.
	): bool					// RETURNS <bool> TRUE if the user is granted an invite, FALSE if not.
...
/****** Create an invitation code  ******/
	...
	(
		int $uniID				// <int> The UniID to give an invitation code to.
	,	int $inviteLevel = 1	// <int> The level of invitation (1 is standard, 3 is free invites, 5 is VIP)
	,	int $numberInvites = 1	// <int> The number of invitations to create for this user.
	): bool						// RETURNS <bool> TRUE if there were invitation codes created, FALSE on failure.
...
/****** Retrieve data about an invitation code ******/
	...
	(
		string $invitationCode		// <str> The invitation code to assign.
	): array <str, mixed>						// RETURNS <str:mixed> data about the invitation, array() on failure.
...
/****** Retrieve data about the invitation code that the user redeemed ******/
	...
	(
		int $uniID		// <int> The UniID of the user to get their invite data from.
	): array <str, mixed>				// RETURNS <str:mixed> the invitation data.
...
/****** Retrieve all of a user's invitation data ******/
	...
	(
		int $uniID		// <int> The invitation code to assign.
	): array <int, array<str, mixed>>				// RETURNS <int:[str:mixed]> a list of invitations from the user.
...
/****** Check if an invitation key is valid (you can redeem it) ******/
	...
	(
		string $inviteCode		// <str> The invitation code to check for validity.
	): bool					// RETURNS <bool> TRUE if the invite code is valid, FALSE if not.
...
/****** Assign an invitation code  ******/
	...
	(
		int $uniID				// <int> The UniID that is being assigned to an invitation code.
	,	string $invitationCode		// <str> The invitation code to assign.
	): bool						// RETURNS <bool> TRUE on successful assignment, FALSE on failure.
