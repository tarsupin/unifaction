...
/****** Check if the user has secondary authentication ******/
	...
	(
		int $uniID			// <int> The AuthID of the user to test for second authentication.
	): bool					// RETURNS <bool> TRUE if second authentication exists, FALSE if not.
...
/****** Create a Security Question ******/
	...
	(
		int $uniID			// <int> The AuthID of the user to prepare the security question for.
	,	string $question		// <str> The security question to ask.
	,	string $answer			// <str> The answer to the security question.
...
/****** Retrieve security question data ******/
	...
	(
		int $uniID			// <int> The UniID of the user to get the question data for.
	): array <str, str>					// RETURNS <str:str> data of the security question.
...
/****** Track a failed login ******/
	...
	(
		int $uniID			// <int> The UniID of the login that failed.
	): bool					// RETURNS <bool> TRUE if failure was tracked, FALSE on error.
...
/****** Checking number of failed logins ******/
	...
	(
		int $uniID			// <int> The UniID to check number of failed logins for.
	,	int $duration = 600	// <int> The duration of time for which to detect failed logins over.
	): int					// RETURNS <int> the number of failed logins within the $duration, 0 on error.
