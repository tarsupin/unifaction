...
/****** Get a single entry ******/
	...
	)					// RETURNS <str:mixed> a list of the content IDs based on recent posts.
...
/****** Get the feed data for the home page ******/
	public static function getFeed (
		$page = 1		// <int> The starting page.
	,	$numRows = 15	// <int> The number of entries to return per page.
	)					// RETURNS <int:[str:mixed]> a list of the content IDs based on recent posts.
...
/****** Add a new entry to the home page ******/
	...
	(
		$uniID			// <int> The UniID of the author.
	,	$url			// <str> The URL of where the article resides.
	,	$title			// <str> The title of the article.
	,	$description	// <str> The description of the article.
	,	$primaryHashtag	// <str> The primary hashtag of the article.
	,	$hashtagList	// <int:str> A list of hashtags that the article used.
	,	$thumbnail		// <str> The URL for the thumbnail of the image.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.s
...
/****** Output a content feed ******/
	...
	(
		$feedData			// <int:[str:mixed]> The array that contains the content entry IDs for the feed.
