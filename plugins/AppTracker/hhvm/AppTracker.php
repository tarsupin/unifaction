...
/****** Get the last connection to a Site ******/
	...
	(
		int $uniID		// <int> The user's Auth ID.
	,	string $siteHandle	// <str> The site handle to identify the site in question.
	): int				// RETURNS <int> the last UniID to access the site, 0 on failure.
...
/****** Get the list of connections that a Uni-Account has made ******/
	...
	): array <int, array<str, mixed>>				// RETURNS <int:[str:mixed]> data from sites connected to, array() on failure.
...
/****** Connect to a Site ******/
	...
	(
		int $uniID		// <int> The Uni-Account that we're tracking.
	,	string $siteHandle	// <str> The site var to identify the site.
