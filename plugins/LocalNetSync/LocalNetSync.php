...
/****** API Variables ******/
	...
	public $microCredits = 15000;		// <int> The cost in microcredits (1/10000 of a credit) to access this API.
	public $minClearance = 8;			// <int> The minimum clearance level required to use this API.
	
	
/****** Run the API ******/
	public function runAPI (
	)					// RETURNS <array> generated key and other data about the site; array() on failure.
