...
/****** Get Network Info ******/
	...
	(
		$siteHandle			// <str> The site handle to get network information about.
	,	$columns = "*"		// <str> The columns to retrieve.
	)						// RETURNS <str:str> data about the site, empty array if nothing is present.
...
/****** Get a list of sites owned by a particular UniID ******/
	...
	(
		$uniID		// <int> The UniID to get a list of sites of.
	)				// RETURNS <int:[str:str]> list of site handles owned (or being registered) by the UniID.
...
/****** Register a site ******/
	...
	(
		$siteHandle			// <str> The site handle to set the network information for.
	,	$uniID				// <int> The UniID that is being registered with this site.
	,	$clearance			// <int> The level of clearance to register with the site.
	,	$siteName			// <str> The name of the site being registered.
	,	$siteURL			// <str> The url that the site is being registered to.
	)						// RETURNS <bool> TRUE if registered properly, FALSE otherwise.
...
/****** Confirm a site ******/
	...
	(
		$siteHandle			// <str> The site handle to confirm.
	,	$uniID				// <int> The UniID that is confirming the site.
	)						// RETURNS <bool> TRUE if confirmed properly, FALSE otherwise.
...
/****** Set Network Info ******/
	...
	(
		$siteHandle			// <str> The site handle to set the network information for.
	,	$category = ""		// <str> The category to associate with the site.
	,	$subcategory = ""	// <str> The subcategory to associate with the site.
	,	$description = ""	// <str> The description of the site.
	,	$keywords = ""		// <str> Keywords (separated by commas) to associate with the site.
	,	$contactName = ""	// <str> The name of the contact of this site.
	,	$contactPhone = ""	// <str> The phone number associated with the site.
	,	$locCountry = ""	// <str> The country that this site is associated with.
	,	$locState = ""		// <str> The state or province that this site is associated with.
	,	$locCity = ""		// <str> The city that this site is associated with or located at.
	,	$locZipcode = ""	// <str> The zipcode that this site is associated with and/or located in.
...
/****** Check if a site handle has already been taken ******/
	...
	(
		$siteHandle			// <str> The site handle to check is available or not.
	)						// RETURNS <bool> TRUE if updated, FALSE otherwise.
...
/****** Get the UniID that owns a site ******/
	...
	(
		$siteHandle			// <str> The site handle to check for the owner.
	)						// RETURNS <int> the UniID of the owner, or 0 if no owner was found.
